...
2026-08-16 재실행에서도 clang 18.1.3과 gcc 9.5.0 전체 빌드가 각각 종료 코드 0,
오류/경고 0건으로 완료됐다. 재생성된 주요 산출물 크기는 다음과 같다.

| 항목 | clang 18.1.3 | gcc 9.5.0 |
|---|---:|---:|
| Image | 40,528,384 | 49,535,488 |
| vmlinux | 430,536,216 | 229,091,424 |
| kvm_nvhe.o | 9,162,088 | 5,394,392 |

재실행 로그는 각 출력 디렉터리의 `build.log`에 있다. Ubuntu의 접미사형 LLVM 실행 파일은
`LLVM=-18`로 선택했다.
