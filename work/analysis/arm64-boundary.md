...
- 측정일: 2026-08-07
- 저장소: `/home/boram1288/orange/arch/poc-p/work/pkvm-linux`
- 기준: `v6.18`(`7d0a66e4`) → `origin/for-android/pkvm-mainline-6.18`(`b3b90af8`)
- 대상: `research/pkvm-kernel-version.md` 8.4절 미결 사항 1번
...
- 문서의 **673커밋 수치는 수정할 필요가 없다.** 이 영역 한정으로는 673 집합이 정확히 재현된다.
