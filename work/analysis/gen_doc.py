...
r = json.load(open('/tmp/classified.json'))
files = json.load(open('/tmp/files858.json'))
mm = json.load(open('/tmp/master_map.json'))
inm = set(mm['inm'])
k3 = json.load(open('/tmp/key3.json'))
...
open('/home/boram1288/orange/arch/poc-p/work/analysis/_data.md', 'w').write('\n'.join(out) + '\n')
